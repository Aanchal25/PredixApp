    ...
    predixApp.controller('MainCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
        ...
        window.App = $rootScope.App = {
            ...
            tabs: [
                ...
                {icon: 'fa-home',state:'cost',label:'Cost Modelling',subitems:[
                    {state:'financial',label:'Financial Model'},
                    {state:'reports',label:'Reports'},
                    {state:'Link1',label:'link1?'},
                    {state:'Link2',label:'link2?'}
                ]}
            ]
        };
